...
And the **`my-first-plugin.js`** file should be a valid [Vue Component](https://vuejs.org/v2/guide/components.html) object, currently you can not write your plugin as a [Single File Component](http://vuejs.org/v2/guide/single-file-components.html), but instead of using the **`<template>`** tag you will write your HTML into the **`template`** field:
...
This should return an array of [route configuration](https://router.vuejs.org/api/#routes) to be used by the [vue-router](https://router.vuejs.org/).
...
**`eventBus`** is an [emittery](https://github.com/sindresorhus/emittery) instance. You can use its methods provided in the documentation. The wallet triggers an event similar to this **`wallet:<address>:transaction:new`** when identifying a new transaction.
...
* [Explorer plugin](https://github.com/ark-ecosystem-desktop-plugins/explorer)
* [Additional avatars plugin](https://github.com/ark-ecosystem-desktop-plugins/additional-avatars)
* [Dark contrast theme plugin](https://github.com/ark-ecosystem-desktop-plugins/dark-contrast-theme)
* [Sound notification plugin](https://github.com/ark-ecosystem-desktop-plugins/sound-notifications)
