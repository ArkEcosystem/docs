---
title: Custom Transactions Guide - Running the Example
---
...
<livewire:page-reference path="/docs/core/development-guides/custom-transactions/loading-the-dapp" />

## STEP 2: Setup Development Docker Database

Setup docker database config and run Postgres DB via Docker. Follow the steps from here: [Core Docker Setup](/docs/core/getting-started/development-setup/docker-linux-macos)

## STEP 3: Start Local Testnet Blockchain

Start local blockchain with testnet running on your developer computer. Follow steps defined in here: [Spinning Up Your First Testnet](/docs/core/getting-started/development-setup/spinning-up-first-testnet#step-2-testnet-network-boot)
                    ...
                    [
                        {
                            ...
                            "fee": "5000000000",
                            "amount": "0",
                            "asset": { "businessData": { "name": "google", "website": "www.google.com" } },
