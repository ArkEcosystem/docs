---
title: Development Guides - API Servers
---
...
As you've learned in [How to write a Core Modules](/docs/core/development-guides/dapps/authoring-core-dapps) you will need to install the required dependencies. For our example we will use we need the **core-http-utils** package which you can install with the following command:
...
Go [here](/docs/core/development-guides/dapps/creating-a-module#step-3-module-registration-within-network-configuration) for detailed explanation on how to achieve this.
...
Now **Go And Start You Local Testnet** Blockchain with the new module enabled by following [this guide](/docs/core/development-guides/dapps/creating-a-module#step-4-running-your-dapp)!
