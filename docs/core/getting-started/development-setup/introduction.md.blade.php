---
title: Development Setup - Introduction
---

# Development Environment Setup Introduction (ADN | Devnet)
...
<livewire:page-reference path="/docs/core/getting-started/development-setup/linux-macos" />

<livewire:page-reference path="/docs/core/getting-started/development-setup/docker-linux-macos" />

<livewire:page-reference path="/docs/core/getting-started/development-setup/docker-windows" />
...
* [Core Server Installation Instructions](/docs/core/getting-started/production-setup/core-node-security) - Server Installation Instructions For Production Node
</x-alert>
