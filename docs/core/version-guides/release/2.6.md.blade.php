...
#### For more information about using the ARK CLI interface go [here](/docs/core/development-guides/command-line-interface/getting-started) <a id="step-1-add-core-magistrate-transactions-package"></a>
