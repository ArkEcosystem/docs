---
title: Upgrade Guides - Core v2.2 to v2.3
---
...
Make sure that [Step 1](/docs/core/version-guides/upgrade/2.3#step-1-adjusting-configuration) was successfully completed before running the `ark update` command via the cli. To update to the v2.3 run the following command:
