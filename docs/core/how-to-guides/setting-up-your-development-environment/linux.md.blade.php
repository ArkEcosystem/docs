---
title: A Step-By-Step Guide on How To Prepare a Fully Functional Development Environment
---
...
Script can be found at the bottom of this page, section ["**Run Above Commands Together In One Setup Script"**](/docs/core/how-to-guides/setting-up-your-development-environment/linux#run-above-commands-together-in-one-setup-script)**.**
</x-alert>
...
After creating and logging under `ark` user, you can execute the following script to install development tools and dependencies from [Technology Stack](../../getting-started/technology-stack.md). If your default user isn't `ark`, you should copy and modify the script source below \(database section\).
