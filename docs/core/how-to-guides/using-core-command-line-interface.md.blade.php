# How to use Core Command Line Interface?
...
<x-alert type="info">
To use Core-CLI, you must first complete the installation of ARK Core to your server. You can install ARK Core by following this [guide](/docs/core/how-to-guides/setting-up-your-production-environment/core-node-secure-setup)
</x-alert>
