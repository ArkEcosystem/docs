---
title: Upgrade Guides - Core v1.0 to v2.0
---
...
All node operators must cooperate in the migration. (Technically [http://0.0.0.0:8080y](http://0.0.0.0:8080) only &gt; 50% of the delegates need to migrate. However, you should avoid a community split). We recommend establishing a dedicated communication channel, monitored by your team during the entire migration process, so that you may provide assistance.
...
Open `packages/core/package.json`. Here the common startup scripts are defined. You can read more on how these work in the [node lifecycle](https://github.com/ArkEcosystem/gitbooks-core/tree/22a1206caace1f8bd949491b5dda4c25798b349b/guidebook/core/node-lifecycle.md) section. We are interested in the `scripts` key.
