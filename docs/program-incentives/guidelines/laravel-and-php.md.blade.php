...
Developing from scratch gives you more control over and allows you to fine-tune the feature to your own specific needs, and of course make you learn something new. On the other hand, reinventing the wheel can cause you to waste more time. Always weigh the advantages and disadvantages before making a final decision. Of course, there are several instances where you would never try to develop your own features, but rather use huge libraries which are actively maintained and would save a lot of time. A few examples are if you need to interact with the Stripe API, or the AWS SDK -- you would never try to build your own, but rather pull in their respective libraries. Sometimes, building from scratch makes for a more maintainable code.

Pulling in a Composer dependency and calling it a day for a feature that would take very little time to build is a good way to get your PR declined.
