...
* **Don't** send pull requests that improve code readability to your liking. _Follow the standards that are specified in the project. Should you have questions, refer to our existing codebases, or [contact us](https://ark.dev/contact).
