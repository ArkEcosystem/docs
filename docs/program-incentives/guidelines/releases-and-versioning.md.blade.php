...
A common standard used for commits is [https://conventionalcommits.org/](https://conventionalcommits.org/). Its spec goes hand in hand with Semantic Versioning and makes compiling changelogs a breeze because all commits are labeled with things like `feat`, `bug` or `refactor`.
