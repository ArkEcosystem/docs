...
app
    .bind<Identifiers.Services.Log.Service>(Contracts.Kernel.Logger)
...
app
    .bind<Contracts.Kernel.Log.Logger>(Contracts.Kernel.Logger)
...
app.get<Contracts.Kernel.Logger>(Contracts.Kernel.Logger);
```
...
app.resolve<Contracts.Kernel.Logger>(ConsoleLogger);
```
