...
For detailed step-by-step instructions on upgrading from **Core v2.7** to **Core v3**, please visit the appropriate link below or proceed to the next page.

<livewire:page-reference path="/docs/core/releases/upgrade/3.0" />

<livewire:page-reference path="/docs/core/releases/upgrade/docker/3.0" />
