...
Ensure your wallet has enough funds to cover the transaction fee. Check [Receive Tokens](/docs/mainsail/testing/tx-tester#receive-tokens) section to receive additional tokens.
...
<x-alert type="info">
Registering a **validator public key** is necessary before you can start forging. When your validator is set up in the node **validator private key** is used to sign consensus messages and block proposals.
</x-alert>
...
Keep your mnemonic and validator private key safe. Do not share it with unauthorized individuals. Different mnemonic can be used for your wallet keys and your validator keys.
</x-alert>
...
Node will check `validator.json` file located on the config path. If mnemonic is included node will automatically detect validator and start forging if your validator is part of active validators list. You can check that in the [ARK Scan - Delegates](https://explorer-demo.mainsailhq.com/delegates).
...
Network participants (wallets) need to vote for your validator to become active. You can check the current votes and rank for your validator in the [ARK Scan - Delegate](https://explorer-demo.mainsailhq.com/delegates) page.
