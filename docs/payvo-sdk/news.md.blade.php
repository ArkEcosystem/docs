...
This is a Blockfolio Integration for the Payvo SDK. The implementation adheres to the contracts laid out in the [specification](/docs/payvo-sdk/specification).
