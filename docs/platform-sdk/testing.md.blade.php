...
The majority of critical functionality in the Payvo SDK requires wallets for testing. It can be quite tedious to figure out how to generate a wallet and find a faucet that is still working so we gathered a list of instructions and working faucets to shorten the time it takes for you to get up and running for development and testing.
