...
This is a Stellar Driver for the Platform SDK. The implementation makes use of [Stellar](https://www.stellar.org/) and adheres to the contracts laid out in the [specification](/docs/platform-sdk/specification). **This package should not be used directly. It is designed to be consumed through the [SDK](/docs/platform-sdk/sdk) package.**

## Repository

<livewire:embed-link url="https://github.com/ArdentHQ/platform-sdk/tree/master/packages/sdk-xlm" />
